  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: '20px 16px 16px', display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <div>
          <p style={{ fontSize: 13, fontWeight: 600, color: '#1D1D1F', margin: 0, lineHeight: 1.3, fontFamily: 'var(--font-sans)' }}>
            늘사랑교회
          </p>
          <p style={{ fontSize: 11, color: '#AEAEB2', margin: 0, lineHeight: 1.3 }}>관리 시스템</p>
        </div>
      </div>
      ...
      <nav style={{ flex: 1, padding: '4px 8px', display: 'flex', flexDirection: 'column', gap: 1 }}>
        {visible.map((item) => {
          ...
          return (
            ...
            >
              <span style={{ color: active ? 'rgba(255,255,255,0.75)' : '#86868B', flexShrink: 0 }}>
                {item.icon}
              </span>
              {item.label}
            </Link>
      ...
      {/* User */}
      <div style={{ padding: '12px 8px 16px', display: 'flex', alignItems: 'center', gap: 8 }}>
        <div style={{
          width: 28, height: 28,
          borderRadius: 50,
          background: '#F2F2F7',
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <p style={{ fontSize: 12, fontWeight: 500, color: '#1D1D1F', margin: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {userName}
          </p>
          <p style={{ fontSize: 11, color: '#AEAEB2', margin: 0 }}>{roleLabel}</p>
        </div>
        <button
          ...
          style={{
            ...
            padding: 4, color: '#AEAEB2', flexShrink: 0,
